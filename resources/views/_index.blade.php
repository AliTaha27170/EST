...
<!-- <section id="about" class="about">
      <div class="container">
        ...
        <div class="row no-gutters">
          <div class="content col-xl-5 d-flex align-items-center aos-init aos-animate" data-aos="fade-up">
            <div class="content">
              <h3>Our Brands</h3>
            </div>
          </div>
          <div class="col-xl-7 d-flex align-items-stretch">
            <div class="icon-boxes d-flex flex-column justify-content-center">
              <div class="row">
                <div class="col-6 icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                  <img class="brand-image" src="{{asset('user/img/brands/laoadicia.png')}}" alt="">
                </div>
                <div class="col-6 icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                <img class="brand-image mt-5" src="{{asset('user/img/brands/alsham.png')}}" alt="">
                </div>
                <div class="col-6 icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                <img class="brand-image" src="{{asset('user/img/brands/shamra.png')}}" alt="">
                </div>
                <div class="col-6 icon-box aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                <img class="brand-image mt-5" src="{{asset('user/img/brands/yara.png')}}" alt="">
                </div>
              </div>
            </div><
          </div>
